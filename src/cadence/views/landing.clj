       ...
       [:div.row-fluid
        [:div.span7
         ...
         [:p "You might be asking, what passed entries? What if this the first
             ...
             authenticate."]
         [:p "On this site authentication does not get you anything special.
             ...
             randomly selected user, or a user for whom you were given a private
             link."]
         [:p "See the "
        ...
        [:div.span5
         [:div.highlight
          ...
          [:p "Accordingly, the logo is " [:em "supposed"]
       ...
       [:div.row-fluid
        ...
        [:div.span6
         ...
         [:p "I take security very seriously. It would be bad practice to
             demonstrate a new method of authentication of and make the demo a
